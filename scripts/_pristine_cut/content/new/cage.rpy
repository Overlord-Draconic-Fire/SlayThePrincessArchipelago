...
label cage_basement_start:
    ...
    menu:
        ...
        "{i}• [[Attack her.]{/i}" if blade_held and hasThisBlade(Item.blade_cage):
...
label cage_basement_second_menu:
    ...
    menu:
        ...
        "{i}• (Explore) ''Screw it.'' [[Attack her.]{/i}" if blade_held and hasThisBlade(Item.blade_cage):
            $ cage_action = True
        ...
        "{i}• (Explore) [[Try to cut yourself free.]{/i}" if paranoid_can_free_cage and hasThisBlade(Item.blade_cage):
...
label cage_encounter_start:
    ...
    menu:
        ...
        "{i}• (Explore) [[Attempt to cut yourself free.]{/i}" if blade_held and cage_cut_route == False and hasThisBlade(Item.blade_cage):
        ...
        "{i}• (Explore) [[Swing your blade.]{/i}" if blade_held and hasThisBlade(Item.blade_cage):
        ...
        "{i}• (Explore) [[Keep cutting.]{/i}" if blade_held and cage_cut_route and hasThisBlade(Item.blade_cage):
...
label cage_menu_2_start:
    ...
    menu:
        ...
        "{i}• [[Cut yourself free.]{/i}" if cage_cut_2 and hasThisBlade(Item.blade_cage):
