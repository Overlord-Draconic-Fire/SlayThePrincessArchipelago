...
label happy_menu:
    ...
    menu:
        ...
        "{i}• [[Slay the Princess.]{/i}" if happy_slay_explore == False and happy_get_up_attempt == False and hasThisBlade(Item.blade_happily):
...
label happy_climax:
    ...
    menu:
        ...
        "{i}• [[Slay the Princess.]{/i}" if happy_slay_attempted == False and hasThisBlade(Item.blade_happily):
            label happy_slay:
                ...
                menu:
                    ...
                    "{i}• Don't get cold feet now. This is for the good of everyone. I'm saving the world here. [[Slay the Princess.]{/i}" if hasThisBlade(Item.blade_happily):
                        jump happy_murder_end

                    "{i}• I know what I decided to do. [[Slay the Princess.]{/i}" if hasThisBlade(Item.blade_happily):
                        jump happy_murder_end
