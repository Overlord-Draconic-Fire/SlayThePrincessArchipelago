...
class Context:
    ...
    async def send_msgs(self, endpoint: Endpoint, msgs: typing.Iterable[dict]) -> bool:
        if not endpoint.socket or getattr(endpoint.socket, "closed", False):
            return False
    ...
    async def broadcast_send_encoded_msgs(self, endpoints: typing.Iterable[Endpoint], msg: str) -> bool:
        ...
        for endpoint in endpoints:
            if endpoint.socket and not getattr(endpoint.socket, "closed", False):
...
def collect_hints(ctx: Context, team: int, slot: int, item: typing.Union[int, str],
                  status: typing.Optional[HintStatus] = None) -> typing.List[Hint]:
    """
...
def collect_hint_location_name(ctx: Context, team: int, slot: int, location: str,
                               status: typing.Optional[HintStatus] = HintStatus.HINT_UNSPECIFIED) -> typing.List[Hint]:
    """
