...
BaseType = typing.Union[
    ...
    float,
    None,
    typing.Tuple["BaseType", ...],
    typing.Dict["BaseType", "BaseType"],
]


def convert_to_base_types(obj: typing.Any) -> BaseType:
    if isinstance(obj, (tuple, list, set, frozenset)):
...
class MultiData(typing.TypedDict):
    ...
    checks_in_area: dict[int, dict[str, typing.Union[int, list[int]]]]
