...
def _extend_freeze_support() -> None:
    """Extend multiprocessing.freeze_support() safely; no-op if multiprocessing is absent."""
    ...
    try:
        ...
        return  # environment (Ren'Py) may not ship multiprocessing
...
def freeze_support() -> None:
    """Call multiprocessing.freeze_support if available; otherwise no-op."""
    try:
        import multiprocessing
    except ImportError:
        return
...
def visualize_regions(root_region: Region, file_name: str, *,
                      ...
                      linetype_ortho: bool = True, regions_to_highlight: typing.Optional[set[Region]] = None) -> None:
