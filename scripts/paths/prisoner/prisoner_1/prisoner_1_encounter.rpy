label prisoner_encounter_start:
    ...
    menu:
        ...
        "{i}• [[Slay the Princess.]{/i}" if blade_held and prisoner_can_slay_attempt and hasThisBlade(Item.blade_prisoner):
            if grey_encountered:
...
label prisoner_menu:
    ...
    menu:
        ...
        "{i}• ''If you want to leave, I'm going to be the one with the weapon. Deal with it.'' [[Cut her out on your own.]{/i}" if prisoner_what_do and hasThisBlade(Item.blade_prisoner):
            $ prisoner_player_attempt_cut = True
            jump prisoner_strangle_join

        "{i}• ''If that's how you're going to be, then I guess I have to do this.'' [[Slay the Princess.]{/i}" if blade_held and prisoner_no_give_explore and prisoner_can_slay_attempt and hasThisBlade(Item.blade_prisoner):
            if grey_encountered:
                $ prisoner_can_slay_attempt = False
                voice "audio/voices/mound/bonus/path.flac"
                mound "This path is already worn by travel and has been seen by one of my many eyes. You cannot walk it again. Change your course.\n"
        ...
        "{i}• ''It seems I don't have much of a choice. I'm sorry.'' [[Slay the Princess.]{/i}" if blade_held and prisoner_locked and prisoner_can_slay_attempt and hasThisBlade(Item.blade_prisoner):
            if grey_encountered:
                $ prisoner_can_slay_attempt = False
                voice "audio/voices/mound/bonus/path.flac"
                mound "This path is already worn by travel and has been seen by one of my many eyes. You cannot walk it again. Change your course.\n"
...
label prisoner_strangle_join:
    ...
    label prisoner_fight_menu:
        menu:
            ...
            "{i}• [[Slay the Princess.]{/i}" if prisoner_can_slay_attempt and hasThisBlade(Item.blade_prisoner):
    ...
    label prisoner_dead_late_join:
        ...
        label prisoner_happy_menu:
            ...
            menu:
                    ...
                    label prisoner_happy_join:
                        ...
                        label prisoner_post_happy_menu:
                            ...
                            menu:
                                ...
                                "{i}• [[Slay yourself.]{/i}" if hasThisBlade(Item.blade_prisoner):
                                    jump prisoner_slay_self_join
                ...
                "{i}• [[Slay yourself.]{/i}" if prisoner_happy_menu_suggestion_explore and hasThisBlade(Item.blade_prisoner):
